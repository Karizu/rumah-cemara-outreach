...
public class com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxy extends com.boardinglabs.rumahcemara.outreach.models.Group
    implements RealmObjectProxy, com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface {
    ...
    static final class GroupColumnInfo extends ColumnInfo {
        ...
        GroupColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.groupProfileIndex = addColumnDetails("groupProfile", "groupProfile", objectSchemaInfo);
        }
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.groupProfileIndex = src.groupProfileIndex;
        }
    }
    ...
    private ProxyState<com.boardinglabs.rumahcemara.outreach.models.Group> proxyState;

    com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.boardinglabs.rumahcemara.outreach.models.Group>(this);
    ...
    @Override
    public com.boardinglabs.rumahcemara.outreach.models.GroupProfile realmGet$groupProfile() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.groupProfileIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.boardinglabs.rumahcemara.outreach.models.GroupProfile.class, proxyState.getRow$realm().getLink(columnInfo.groupProfileIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$groupProfile(com.boardinglabs.rumahcemara.outreach.models.GroupProfile value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            if (proxyState.getExcludeFields$realm().contains("groupProfile")) {
                return;
            }
            ...
            if (value == null) {
                ...
                row.nullifyLink(columnInfo.groupProfileIndex);
                return;
            }
            proxyState.checkValidObject(value);
            row.getTable().setLink(columnInfo.groupProfileIndex, row.getIndex(), ((RealmObjectProxy) value).realmGet$proxyState().getRow$realm().getIndex(), true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().nullifyLink(columnInfo.groupProfileIndex);
            return;
        }
        proxyState.checkValidObject(value);
        proxyState.getRow$realm().setLink(columnInfo.groupProfileIndex, ((RealmObjectProxy) value).realmGet$proxyState().getRow$realm().getIndex());
    }

    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Group", 12, 0);
        ...
        builder.addPersistedLinkProperty("groupProfile", RealmFieldType.OBJECT, "GroupProfile");
    ...
    @SuppressWarnings("cast")
    public static com.boardinglabs.rumahcemara.outreach.models.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("groupProfile")) {
            excludeFields.add("groupProfile");
        }
        com.boardinglabs.rumahcemara.outreach.models.Group obj = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Group.class, true, excludeFields);

        final com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
        ...
        if (json.has("groupProfile")) {
            if (json.isNull("groupProfile")) {
                objProxy.realmSet$groupProfile(null);
            } else {
                com.boardinglabs.rumahcemara.outreach.models.GroupProfile groupProfileObj = com_boardinglabs_rumahcemara_outreach_models_GroupProfileRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("groupProfile"), update);
                objProxy.realmSet$groupProfile(groupProfileObj);
            }
        }
        return obj;
    }
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Group createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.boardinglabs.rumahcemara.outreach.models.Group obj = new com.boardinglabs.rumahcemara.outreach.models.Group();
        final com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            } else if (name.equals("groupProfile")) {
                if (reader.peek() == JsonToken.NULL) {
                    reader.skipValue();
                    objProxy.realmSet$groupProfile(null);
                } else {
                    com.boardinglabs.rumahcemara.outreach.models.GroupProfile groupProfileObj = com_boardinglabs_rumahcemara_outreach_models_GroupProfileRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$groupProfile(groupProfileObj);
                }
            } else {
                reader.skipValue();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Group copyOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.boardinglabs.rumahcemara.outreach.models.Group) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.boardinglabs.rumahcemara.outreach.models.Group copy(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.boardinglabs.rumahcemara.outreach.models.Group realmObject = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Group.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) newObject;
        com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface realmObjectCopy = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) realmObject;
        ...
        com.boardinglabs.rumahcemara.outreach.models.GroupProfile groupProfileObj = realmObjectSource.realmGet$groupProfile();
        if (groupProfileObj == null) {
            realmObjectCopy.realmSet$groupProfile(null);
        } else {
            com.boardinglabs.rumahcemara.outreach.models.GroupProfile cachegroupProfile = (com.boardinglabs.rumahcemara.outreach.models.GroupProfile) cache.get(groupProfileObj);
            if (cachegroupProfile != null) {
                realmObjectCopy.realmSet$groupProfile(cachegroupProfile);
            } else {
                realmObjectCopy.realmSet$groupProfile(com_boardinglabs_rumahcemara_outreach_models_GroupProfileRealmProxy.copyOrUpdate(realm, groupProfileObj, update, cache));
            }
        }
        return realmObject;
    }

    public static long insert(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Group.class);
        long tableNativePtr = table.getNativePtr();
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Group.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$id = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$parentId = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$parentId();
        if (realmGet$parentId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.parentIdIndex, rowIndex, realmGet$parentId, false);
        }
        String realmGet$pic = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$pic();
        if (realmGet$pic != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.picIndex, rowIndex, realmGet$pic, false);
        }
        String realmGet$name = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$address = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$address();
        if (realmGet$address != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.addressIndex, rowIndex, realmGet$address, false);
        }
        String realmGet$picture = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$picture();
        if (realmGet$picture != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.pictureIndex, rowIndex, realmGet$picture, false);
        }
        String realmGet$areas = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$areas();
        if (realmGet$areas != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.areasIndex, rowIndex, realmGet$areas, false);
        }
        Boolean realmGet$isParent = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$isParent();
        if (realmGet$isParent != null) {
            Table.nativeSetBoolean(tableNativePtr, columnInfo.isParentIndex, rowIndex, realmGet$isParent, false);
        }
        String realmGet$createdAt = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updatedAt = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updatedAtIndex, rowIndex, realmGet$updatedAt, false);
        }
        String realmGet$deletedAt = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$deletedAt();
        ...
        com.boardinglabs.rumahcemara.outreach.models.GroupProfile groupProfileObj = ((com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) object).realmGet$groupProfile();
        if (groupProfileObj != null) {
            Long cachegroupProfile = cache.get(groupProfileObj);
            if (cachegroupProfile == null) {
                cachegroupProfile = com_boardinglabs_rumahcemara_outreach_models_GroupProfileRealmProxy.insert(realm, groupProfileObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupProfileIndex, rowIndex, cachegroupProfile, false);
        }
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Group.class);
        com.boardinglabs.rumahcemara.outreach.models.Group object = null;
        while (objects.hasNext()) {
            object = (com.boardinglabs.rumahcemara.outreach.models.Group) objects.next();
            ...
            if (groupProfileObj != null) {
                ...
                table.setLink(columnInfo.groupProfileIndex, rowIndex, cachegroupProfile, false);
            }
        }
    }

    public static long insertOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Group.class);
        ...
        if (groupProfileObj != null) {
            Long cachegroupProfile = cache.get(groupProfileObj);
            if (cachegroupProfile == null) {
                cachegroupProfile = com_boardinglabs_rumahcemara_outreach_models_GroupProfileRealmProxy.insertOrUpdate(realm, groupProfileObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupProfileIndex, rowIndex, cachegroupProfile, false);
        } else {
            Table.nativeNullifyLink(tableNativePtr, columnInfo.groupProfileIndex, rowIndex);
        }
        return rowIndex;
    }
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Group createDetachedCopy(com.boardinglabs.rumahcemara.outreach.models.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.boardinglabs.rumahcemara.outreach.models.Group unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.boardinglabs.rumahcemara.outreach.models.Group();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.boardinglabs.rumahcemara.outreach.models.Group) cachedObject.object;
            }
            unmanagedObject = (com.boardinglabs.rumahcemara.outreach.models.Group) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface unmanagedCopy = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) unmanagedObject;
        com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface realmSource = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxyInterface) realmObject;
        ...
        // Deep copy of groupProfile
        unmanagedCopy.realmSet$groupProfile(com_boardinglabs_rumahcemara_outreach_models_GroupProfileRealmProxy.createDetachedCopy(realmSource.realmGet$groupProfile(), currentDepth + 1, maxDepth, cache));
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{groupProfile:");
        stringBuilder.append(realmGet$groupProfile() != null ? "GroupProfile" : "null");
        stringBuilder.append("}");
        stringBuilder.append("]");
    ...
    public boolean equals(Object o) {
        ...
        com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxy aGroup = (com_boardinglabs_rumahcemara_outreach_models_GroupRealmProxy)o;
