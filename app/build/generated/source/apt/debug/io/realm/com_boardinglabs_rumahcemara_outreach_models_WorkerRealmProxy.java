...
public class com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy extends com.boardinglabs.rumahcemara.outreach.models.Worker
    implements RealmObjectProxy, com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface {
    ...
    static final class WorkerColumnInfo extends ColumnInfo {
        ...
        WorkerColumnInfo(OsSchemaInfo schemaInfo) {
            super(10);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("Worker");
        ...
        WorkerColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new WorkerColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final WorkerColumnInfo src = (WorkerColumnInfo) rawSrc;
            final WorkerColumnInfo dst = (WorkerColumnInfo) rawDst;
    ...
    private ProxyState<com.boardinglabs.rumahcemara.outreach.models.Worker> proxyState;

    com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (WorkerColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.boardinglabs.rumahcemara.outreach.models.Worker>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Worker", 10, 0);
    ...
    public static WorkerColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new WorkerColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "Worker";
    }

    @SuppressWarnings("cast")
    public static com.boardinglabs.rumahcemara.outreach.models.Worker createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.boardinglabs.rumahcemara.outreach.models.Worker obj = null;
        if (update) {
            Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
            WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Worker.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy) realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Worker.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy) realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Worker.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) obj;
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Worker createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.boardinglabs.rumahcemara.outreach.models.Worker obj = new com.boardinglabs.rumahcemara.outreach.models.Worker();
        final com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Worker copyOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Worker object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.boardinglabs.rumahcemara.outreach.models.Worker) cachedRealmObject;
        }

        com.boardinglabs.rumahcemara.outreach.models.Worker realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
            WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Worker.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Worker copy(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Worker newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.boardinglabs.rumahcemara.outreach.models.Worker realmObject = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Worker.class, ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) newObject;
        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface realmObjectCopy = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Worker object, Map<RealmModel,Long> cache) {
        ...
        WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$username = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$username();
        if (realmGet$username != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.usernameIndex, rowIndex, realmGet$username, false);
        }
        String realmGet$email = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$password = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$password();
        if (realmGet$password != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.passwordIndex, rowIndex, realmGet$password, false);
        }
        String realmGet$roleId = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$roleId();
        if (realmGet$roleId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.roleIdIndex, rowIndex, realmGet$roleId, false);
        }
        Number realmGet$status = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetLong(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status.longValue(), false);
        }
        String realmGet$createdAt = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updatedAt = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updatedAtIndex, rowIndex, realmGet$updatedAt, false);
        }
        String realmGet$deletedAt = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$deletedAt();
        ...
        com.boardinglabs.rumahcemara.outreach.models.Profile profileObj = ((com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) object).realmGet$profile();
        if (profileObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.boardinglabs.rumahcemara.outreach.models.Worker object = null;
        while (objects.hasNext()) {
            object = (com.boardinglabs.rumahcemara.outreach.models.Worker) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Worker object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Worker.class);
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Worker createDetachedCopy(com.boardinglabs.rumahcemara.outreach.models.Worker realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.boardinglabs.rumahcemara.outreach.models.Worker unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.boardinglabs.rumahcemara.outreach.models.Worker();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.boardinglabs.rumahcemara.outreach.models.Worker) cachedObject.object;
            }
            unmanagedObject = (com.boardinglabs.rumahcemara.outreach.models.Worker) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface unmanagedCopy = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) unmanagedObject;
        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface realmSource = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) realmObject;
    ...
    static com.boardinglabs.rumahcemara.outreach.models.Worker update(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Worker realmObject, com.boardinglabs.rumahcemara.outreach.models.Worker newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface realmObjectTarget = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) realmObject;
        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxyInterface) newObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("Worker = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy aWorker = (com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aWorker.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aWorker.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aWorker.proxyState.getRow$realm().getIndex()) return false;
