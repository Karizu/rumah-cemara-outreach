...
public class com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxy extends com.boardinglabs.rumahcemara.outreach.models.Appointment
    implements RealmObjectProxy, com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface {
    ...
    private ProxyState<com.boardinglabs.rumahcemara.outreach.models.Appointment> proxyState;

    com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.boardinglabs.rumahcemara.outreach.models.Appointment>(this);
    ...
    public com.boardinglabs.rumahcemara.outreach.models.User realmGet$user() {
        ...
        return proxyState.getRealm$realm().get(com.boardinglabs.rumahcemara.outreach.models.User.class, proxyState.getRow$realm().getLink(columnInfo.userIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.boardinglabs.rumahcemara.outreach.models.ServiceType realmGet$serviceType() {
        ...
        return proxyState.getRealm$realm().get(com.boardinglabs.rumahcemara.outreach.models.ServiceType.class, proxyState.getRow$realm().getLink(columnInfo.serviceTypeIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.boardinglabs.rumahcemara.outreach.models.Worker realmGet$worker() {
        ...
        return proxyState.getRealm$realm().get(com.boardinglabs.rumahcemara.outreach.models.Worker.class, proxyState.getRow$realm().getLink(columnInfo.workerIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.boardinglabs.rumahcemara.outreach.models.ProviderWorker realmGet$providerWorker() {
        ...
        return proxyState.getRealm$realm().get(com.boardinglabs.rumahcemara.outreach.models.ProviderWorker.class, proxyState.getRow$realm().getLink(columnInfo.providerWorkerIndex), false, Collections.<String>emptyList());
    }
    ...
    public com.boardinglabs.rumahcemara.outreach.models.Rating realmGet$rating() {
        ...
        return proxyState.getRealm$realm().get(com.boardinglabs.rumahcemara.outreach.models.Rating.class, proxyState.getRow$realm().getLink(columnInfo.ratingIndex), false, Collections.<String>emptyList());
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Appointment", 24, 0);
    ...
    @SuppressWarnings("cast")
    public static com.boardinglabs.rumahcemara.outreach.models.Appointment createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.boardinglabs.rumahcemara.outreach.models.Appointment obj = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Appointment.class, true, excludeFields);

        final com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
        ...
        if (json.has("user")) {
            if (json.isNull("user")) {
                ...
                com.boardinglabs.rumahcemara.outreach.models.User userObj = com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("user"), update);
        ...
        if (json.has("serviceType")) {
            if (json.isNull("serviceType")) {
                ...
                com.boardinglabs.rumahcemara.outreach.models.ServiceType serviceTypeObj = com_boardinglabs_rumahcemara_outreach_models_ServiceTypeRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("serviceType"), update);
        ...
        if (json.has("worker")) {
            if (json.isNull("worker")) {
                ...
                com.boardinglabs.rumahcemara.outreach.models.Worker workerObj = com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("worker"), update);
        ...
        if (json.has("providerWorker")) {
            if (json.isNull("providerWorker")) {
                ...
                com.boardinglabs.rumahcemara.outreach.models.ProviderWorker providerWorkerObj = com_boardinglabs_rumahcemara_outreach_models_ProviderWorkerRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("providerWorker"), update);
        ...
        if (json.has("rating")) {
            if (json.isNull("rating")) {
                ...
                com.boardinglabs.rumahcemara.outreach.models.Rating ratingObj = com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("rating"), update);
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Appointment createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.boardinglabs.rumahcemara.outreach.models.Appointment obj = new com.boardinglabs.rumahcemara.outreach.models.Appointment();
        final com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.boardinglabs.rumahcemara.outreach.models.User userObj = com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$user(userObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.boardinglabs.rumahcemara.outreach.models.ServiceType serviceTypeObj = com_boardinglabs_rumahcemara_outreach_models_ServiceTypeRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$serviceType(serviceTypeObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.boardinglabs.rumahcemara.outreach.models.Worker workerObj = com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$worker(workerObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.boardinglabs.rumahcemara.outreach.models.ProviderWorker providerWorkerObj = com_boardinglabs_rumahcemara_outreach_models_ProviderWorkerRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$providerWorker(providerWorkerObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.boardinglabs.rumahcemara.outreach.models.Rating ratingObj = com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$rating(ratingObj);
                }
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Appointment copyOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Appointment object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.boardinglabs.rumahcemara.outreach.models.Appointment) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.boardinglabs.rumahcemara.outreach.models.Appointment copy(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Appointment newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.boardinglabs.rumahcemara.outreach.models.Appointment realmObject = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Appointment.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) newObject;
        com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface realmObjectCopy = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) realmObject;
        ...
        com.boardinglabs.rumahcemara.outreach.models.User userObj = realmObjectSource.realmGet$user();
        if (userObj == null) {
            realmObjectCopy.realmSet$user(null);
        } else {
            com.boardinglabs.rumahcemara.outreach.models.User cacheuser = (com.boardinglabs.rumahcemara.outreach.models.User) cache.get(userObj);
            if (cacheuser != null) {
                realmObjectCopy.realmSet$user(cacheuser);
            } else {
                realmObjectCopy.realmSet$user(com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy.copyOrUpdate(realm, userObj, update, cache));
            }
        }

        com.boardinglabs.rumahcemara.outreach.models.ServiceType serviceTypeObj = realmObjectSource.realmGet$serviceType();
        if (serviceTypeObj == null) {
            realmObjectCopy.realmSet$serviceType(null);
        } else {
            com.boardinglabs.rumahcemara.outreach.models.ServiceType cacheserviceType = (com.boardinglabs.rumahcemara.outreach.models.ServiceType) cache.get(serviceTypeObj);
            if (cacheserviceType != null) {
                realmObjectCopy.realmSet$serviceType(cacheserviceType);
            } else {
                realmObjectCopy.realmSet$serviceType(com_boardinglabs_rumahcemara_outreach_models_ServiceTypeRealmProxy.copyOrUpdate(realm, serviceTypeObj, update, cache));
            }
        }

        com.boardinglabs.rumahcemara.outreach.models.Worker workerObj = realmObjectSource.realmGet$worker();
        if (workerObj == null) {
            realmObjectCopy.realmSet$worker(null);
        } else {
            com.boardinglabs.rumahcemara.outreach.models.Worker cacheworker = (com.boardinglabs.rumahcemara.outreach.models.Worker) cache.get(workerObj);
            if (cacheworker != null) {
                realmObjectCopy.realmSet$worker(cacheworker);
            } else {
                realmObjectCopy.realmSet$worker(com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy.copyOrUpdate(realm, workerObj, update, cache));
            }
        }

        com.boardinglabs.rumahcemara.outreach.models.ProviderWorker providerWorkerObj = realmObjectSource.realmGet$providerWorker();
        if (providerWorkerObj == null) {
            realmObjectCopy.realmSet$providerWorker(null);
        } else {
            com.boardinglabs.rumahcemara.outreach.models.ProviderWorker cacheproviderWorker = (com.boardinglabs.rumahcemara.outreach.models.ProviderWorker) cache.get(providerWorkerObj);
            if (cacheproviderWorker != null) {
                realmObjectCopy.realmSet$providerWorker(cacheproviderWorker);
            } else {
                realmObjectCopy.realmSet$providerWorker(com_boardinglabs_rumahcemara_outreach_models_ProviderWorkerRealmProxy.copyOrUpdate(realm, providerWorkerObj, update, cache));
            }
        }

        com.boardinglabs.rumahcemara.outreach.models.Rating ratingObj = realmObjectSource.realmGet$rating();
        if (ratingObj == null) {
            realmObjectCopy.realmSet$rating(null);
        } else {
            com.boardinglabs.rumahcemara.outreach.models.Rating cacherating = (com.boardinglabs.rumahcemara.outreach.models.Rating) cache.get(ratingObj);
            if (cacherating != null) {
                realmObjectCopy.realmSet$rating(cacherating);
            } else {
                realmObjectCopy.realmSet$rating(com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy.copyOrUpdate(realm, ratingObj, update, cache));
            }
        }
    ...
    public static long insert(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Appointment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Appointment.class);
        long tableNativePtr = table.getNativePtr();
        AppointmentColumnInfo columnInfo = (AppointmentColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Appointment.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$id = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$group_id = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$group_id();
        if (realmGet$group_id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.group_idIndex, rowIndex, realmGet$group_id, false);
        }
        String realmGet$user_id = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$user_id();
        if (realmGet$user_id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.user_idIndex, rowIndex, realmGet$user_id, false);
        }
        String realmGet$provider_id = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$provider_id();
        ...
        String realmGet$service_type_id = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$service_type_id();
        ...
        String realmGet$worker_id = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$worker_id();
        ...
        String realmGet$start_date = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$start_date();
        ...
        String realmGet$end_date = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$end_date();
        if (realmGet$end_date != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.end_dateIndex, rowIndex, realmGet$end_date, false);
        }
        String realmGet$description = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.descriptionIndex, rowIndex, realmGet$description, false);
        }
        String realmGet$attachment = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$attachment();
        ...
        String realmGet$type_provider = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$type_provider();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.statusIndex, rowIndex, ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$status(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.status_reportIndex, rowIndex, ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$status_report(), false);

        com.boardinglabs.rumahcemara.outreach.models.Group groupObj = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        com.boardinglabs.rumahcemara.outreach.models.User userObj = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$user();
        if (userObj != null) {
            Long cacheuser = cache.get(userObj);
            if (cacheuser == null) {
                cacheuser = com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy.insert(realm, userObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.userIndex, rowIndex, cacheuser, false);
        }

        com.boardinglabs.rumahcemara.outreach.models.ServiceType serviceTypeObj = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$serviceType();
        if (serviceTypeObj != null) {
            Long cacheserviceType = cache.get(serviceTypeObj);
            if (cacheserviceType == null) {
                cacheserviceType = com_boardinglabs_rumahcemara_outreach_models_ServiceTypeRealmProxy.insert(realm, serviceTypeObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.serviceTypeIndex, rowIndex, cacheserviceType, false);
        }

        com.boardinglabs.rumahcemara.outreach.models.Worker workerObj = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$worker();
        if (workerObj != null) {
            Long cacheworker = cache.get(workerObj);
            if (cacheworker == null) {
                cacheworker = com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy.insert(realm, workerObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.workerIndex, rowIndex, cacheworker, false);
        }

        com.boardinglabs.rumahcemara.outreach.models.ProviderWorker providerWorkerObj = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$providerWorker();
        if (providerWorkerObj != null) {
            Long cacheproviderWorker = cache.get(providerWorkerObj);
            if (cacheproviderWorker == null) {
                cacheproviderWorker = com_boardinglabs_rumahcemara_outreach_models_ProviderWorkerRealmProxy.insert(realm, providerWorkerObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.providerWorkerIndex, rowIndex, cacheproviderWorker, false);
        }

        com.boardinglabs.rumahcemara.outreach.models.Rating ratingObj = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$rating();
        if (ratingObj != null) {
            Long cacherating = cache.get(ratingObj);
            if (cacherating == null) {
                cacherating = com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy.insert(realm, ratingObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.ratingIndex, rowIndex, cacherating, false);
        }
        String realmGet$created_at = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$created_at();
        if (realmGet$created_at != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.created_atIndex, rowIndex, realmGet$created_at, false);
        }
        String realmGet$updated_at = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$updated_at();
        if (realmGet$updated_at != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updated_atIndex, rowIndex, realmGet$updated_at, false);
        }
        String realmGet$deleted_at = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$deleted_at();
        ...
        String realmGet$type = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$type();
        if (realmGet$type != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.typeIndex, rowIndex, realmGet$type, false);
        }
        String realmGet$location = ((com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) object).realmGet$location();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        AppointmentColumnInfo columnInfo = (AppointmentColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Appointment.class);
        com.boardinglabs.rumahcemara.outreach.models.Appointment object = null;
        while (objects.hasNext()) {
            object = (com.boardinglabs.rumahcemara.outreach.models.Appointment) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Appointment object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Appointment.class);
        ...
        if (userObj != null) {
            Long cacheuser = cache.get(userObj);
            if (cacheuser == null) {
                cacheuser = com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy.insertOrUpdate(realm, userObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.userIndex, rowIndex, cacheuser, false);
        } else {
        ...
        if (serviceTypeObj != null) {
            Long cacheserviceType = cache.get(serviceTypeObj);
            if (cacheserviceType == null) {
                cacheserviceType = com_boardinglabs_rumahcemara_outreach_models_ServiceTypeRealmProxy.insertOrUpdate(realm, serviceTypeObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.serviceTypeIndex, rowIndex, cacheserviceType, false);
        } else {
        ...
        if (workerObj != null) {
            Long cacheworker = cache.get(workerObj);
            if (cacheworker == null) {
                cacheworker = com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy.insertOrUpdate(realm, workerObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.workerIndex, rowIndex, cacheworker, false);
        } else {
        ...
        if (providerWorkerObj != null) {
            Long cacheproviderWorker = cache.get(providerWorkerObj);
            if (cacheproviderWorker == null) {
                cacheproviderWorker = com_boardinglabs_rumahcemara_outreach_models_ProviderWorkerRealmProxy.insertOrUpdate(realm, providerWorkerObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.providerWorkerIndex, rowIndex, cacheproviderWorker, false);
        } else {
        ...
        if (ratingObj != null) {
            Long cacherating = cache.get(ratingObj);
            if (cacherating == null) {
                cacherating = com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy.insertOrUpdate(realm, ratingObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.ratingIndex, rowIndex, cacherating, false);
        } else {
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Appointment createDetachedCopy(com.boardinglabs.rumahcemara.outreach.models.Appointment realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.boardinglabs.rumahcemara.outreach.models.Appointment unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.boardinglabs.rumahcemara.outreach.models.Appointment();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.boardinglabs.rumahcemara.outreach.models.Appointment) cachedObject.object;
            }
            unmanagedObject = (com.boardinglabs.rumahcemara.outreach.models.Appointment) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface unmanagedCopy = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) unmanagedObject;
        com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface realmSource = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxyInterface) realmObject;
        ...
        // Deep copy of user
        unmanagedCopy.realmSet$user(com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy.createDetachedCopy(realmSource.realmGet$user(), currentDepth + 1, maxDepth, cache));

        // Deep copy of serviceType
        unmanagedCopy.realmSet$serviceType(com_boardinglabs_rumahcemara_outreach_models_ServiceTypeRealmProxy.createDetachedCopy(realmSource.realmGet$serviceType(), currentDepth + 1, maxDepth, cache));

        // Deep copy of worker
        unmanagedCopy.realmSet$worker(com_boardinglabs_rumahcemara_outreach_models_WorkerRealmProxy.createDetachedCopy(realmSource.realmGet$worker(), currentDepth + 1, maxDepth, cache));

        // Deep copy of providerWorker
        unmanagedCopy.realmSet$providerWorker(com_boardinglabs_rumahcemara_outreach_models_ProviderWorkerRealmProxy.createDetachedCopy(realmSource.realmGet$providerWorker(), currentDepth + 1, maxDepth, cache));

        // Deep copy of rating
        unmanagedCopy.realmSet$rating(com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy.createDetachedCopy(realmSource.realmGet$rating(), currentDepth + 1, maxDepth, cache));
    ...
    public boolean equals(Object o) {
        ...
        com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxy aAppointment = (com_boardinglabs_rumahcemara_outreach_models_AppointmentRealmProxy)o;
