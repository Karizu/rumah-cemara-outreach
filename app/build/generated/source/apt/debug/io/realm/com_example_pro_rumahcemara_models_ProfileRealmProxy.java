...
public class com_example_pro_rumahcemara_models_ProfileRealmProxy extends com.example.pro.rumahcemara.models.Profile
    implements RealmObjectProxy, com_example_pro_rumahcemara_models_ProfileRealmProxyInterface {
    ...
    private ProxyState<com.example.pro.rumahcemara.models.Profile> proxyState;

    com_example_pro_rumahcemara_models_ProfileRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.pro.rumahcemara.models.Profile>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.pro.rumahcemara.models.Profile createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("group")) {
            excludeFields.add("group");
        }
        com.example.pro.rumahcemara.models.Profile obj = realm.createObjectInternal(com.example.pro.rumahcemara.models.Profile.class, true, excludeFields);

        final com_example_pro_rumahcemara_models_ProfileRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) obj;
        if (json.has("userId")) {
    ...
    public static com.example.pro.rumahcemara.models.Profile createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.example.pro.rumahcemara.models.Profile obj = new com.example.pro.rumahcemara.models.Profile();
        final com_example_pro_rumahcemara_models_ProfileRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.pro.rumahcemara.models.Profile copyOrUpdate(Realm realm, com.example.pro.rumahcemara.models.Profile object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.pro.rumahcemara.models.Profile) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.example.pro.rumahcemara.models.Profile copy(Realm realm, com.example.pro.rumahcemara.models.Profile newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.pro.rumahcemara.models.Profile realmObject = realm.createObjectInternal(com.example.pro.rumahcemara.models.Profile.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_pro_rumahcemara_models_ProfileRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) newObject;
        com_example_pro_rumahcemara_models_ProfileRealmProxyInterface realmObjectCopy = (com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.pro.rumahcemara.models.Profile object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.Profile.class);
        long tableNativePtr = table.getNativePtr();
        ProfileColumnInfo columnInfo = (ProfileColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Profile.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$userId = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$groupId = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$groupId();
        if (realmGet$groupId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.groupIdIndex, rowIndex, realmGet$groupId, false);
        }
        String realmGet$fullname = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$fullname();
        if (realmGet$fullname != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fullnameIndex, rowIndex, realmGet$fullname, false);
        }
        String realmGet$phoneNumber = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$phoneNumber();
        if (realmGet$phoneNumber != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneNumberIndex, rowIndex, realmGet$phoneNumber, false);
        }
        String realmGet$birthPlace = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$birthPlace();
        ...
        String realmGet$birthDate = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$birthDate();
        ...
        String realmGet$email = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$address = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$address();
        if (realmGet$address != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.addressIndex, rowIndex, realmGet$address, false);
        }
        String realmGet$picture = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$picture();
        if (realmGet$picture != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.pictureIndex, rowIndex, realmGet$picture, false);
        }
        String realmGet$hobby = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$hobby();
        if (realmGet$hobby != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.hobbyIndex, rowIndex, realmGet$hobby, false);
        }
        String realmGet$city = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$city();
        if (realmGet$city != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.cityIndex, rowIndex, realmGet$city, false);
        }
        String realmGet$work = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$work();
        if (realmGet$work != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.workIndex, rowIndex, realmGet$work, false);
        }
        String realmGet$whatsupNumber = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$whatsupNumber();
        ...
        String realmGet$lineAccount = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$lineAccount();
        ...
        String realmGet$pinBbm = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$pinBbm();
        if (realmGet$pinBbm != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.pinBbmIndex, rowIndex, realmGet$pinBbm, false);
        }
        String realmGet$facebookAccount = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$facebookAccount();
        ...
        String realmGet$twitterAccount = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$twitterAccount();
        ...
        String realmGet$shirtSize = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$shirtSize();
        ...
        com.example.pro.rumahcemara.models.Group groupObj = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
        ...
        String realmGet$privacyConfig = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$privacyConfig();
        ...
        String realmGet$instagramAccount = ((com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) object).realmGet$instagramAccount();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ProfileColumnInfo columnInfo = (ProfileColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Profile.class);
        com.example.pro.rumahcemara.models.Profile object = null;
        while (objects.hasNext()) {
            object = (com.example.pro.rumahcemara.models.Profile) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.pro.rumahcemara.models.Profile object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.Profile.class);
    ...
    public static com.example.pro.rumahcemara.models.Profile createDetachedCopy(com.example.pro.rumahcemara.models.Profile realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.pro.rumahcemara.models.Profile unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.pro.rumahcemara.models.Profile();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.pro.rumahcemara.models.Profile) cachedObject.object;
            }
            unmanagedObject = (com.example.pro.rumahcemara.models.Profile) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_pro_rumahcemara_models_ProfileRealmProxyInterface unmanagedCopy = (com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) unmanagedObject;
        com_example_pro_rumahcemara_models_ProfileRealmProxyInterface realmSource = (com_example_pro_rumahcemara_models_ProfileRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_pro_rumahcemara_models_ProfileRealmProxy aProfile = (com_example_pro_rumahcemara_models_ProfileRealmProxy)o;
