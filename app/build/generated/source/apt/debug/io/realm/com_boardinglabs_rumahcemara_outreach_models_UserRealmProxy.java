...
public class com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy extends com.boardinglabs.rumahcemara.outreach.models.User
    implements RealmObjectProxy, com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface {
    ...
    private ProxyState<com.boardinglabs.rumahcemara.outreach.models.User> proxyState;

    com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.boardinglabs.rumahcemara.outreach.models.User>(this);
    ...
    @SuppressWarnings("cast")
    public static com.boardinglabs.rumahcemara.outreach.models.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.boardinglabs.rumahcemara.outreach.models.User obj = null;
        if (update) {
            Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.User.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy) realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy) realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.User.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) obj;
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.boardinglabs.rumahcemara.outreach.models.User obj = new com.boardinglabs.rumahcemara.outreach.models.User();
        final com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.User copyOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.boardinglabs.rumahcemara.outreach.models.User) cachedRealmObject;
        }

        com.boardinglabs.rumahcemara.outreach.models.User realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.User.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.User.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.User copy(Realm realm, com.boardinglabs.rumahcemara.outreach.models.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.boardinglabs.rumahcemara.outreach.models.User realmObject = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.User.class, ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) newObject;
        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface realmObjectCopy = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.boardinglabs.rumahcemara.outreach.models.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$username = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$username();
        if (realmGet$username != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.usernameIndex, rowIndex, realmGet$username, false);
        }
        String realmGet$email = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$password = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$password();
        if (realmGet$password != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.passwordIndex, rowIndex, realmGet$password, false);
        }
        String realmGet$roleId = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$roleId();
        if (realmGet$roleId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.roleIdIndex, rowIndex, realmGet$roleId, false);
        }
        Number realmGet$status = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetLong(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status.longValue(), false);
        }
        String realmGet$createdAt = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updatedAt = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updatedAtIndex, rowIndex, realmGet$updatedAt, false);
        }
        String realmGet$deletedAt = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$deletedAt();
        ...
        com.boardinglabs.rumahcemara.outreach.models.Profile profileObj = ((com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) object).realmGet$profile();
        if (profileObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.boardinglabs.rumahcemara.outreach.models.User object = null;
        while (objects.hasNext()) {
            object = (com.boardinglabs.rumahcemara.outreach.models.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.User.class);
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.User createDetachedCopy(com.boardinglabs.rumahcemara.outreach.models.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.boardinglabs.rumahcemara.outreach.models.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.boardinglabs.rumahcemara.outreach.models.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.boardinglabs.rumahcemara.outreach.models.User) cachedObject.object;
            }
            unmanagedObject = (com.boardinglabs.rumahcemara.outreach.models.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface unmanagedCopy = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) unmanagedObject;
        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface realmSource = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) realmObject;
    ...
    static com.boardinglabs.rumahcemara.outreach.models.User update(Realm realm, com.boardinglabs.rumahcemara.outreach.models.User realmObject, com.boardinglabs.rumahcemara.outreach.models.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface realmObjectTarget = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) realmObject;
        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy aUser = (com_boardinglabs_rumahcemara_outreach_models_UserRealmProxy)o;
