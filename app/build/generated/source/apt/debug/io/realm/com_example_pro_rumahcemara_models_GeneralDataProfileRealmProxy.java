...
public class com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxy extends com.example.pro.rumahcemara.models.GeneralDataProfile
    implements RealmObjectProxy, com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface {
    ...
    private ProxyState<com.example.pro.rumahcemara.models.GeneralDataProfile> proxyState;

    com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.pro.rumahcemara.models.GeneralDataProfile>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.pro.rumahcemara.models.GeneralDataProfile createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("profile")) {
            excludeFields.add("profile");
        }
        com.example.pro.rumahcemara.models.GeneralDataProfile obj = realm.createObjectInternal(com.example.pro.rumahcemara.models.GeneralDataProfile.class, true, excludeFields);

        final com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static com.example.pro.rumahcemara.models.GeneralDataProfile createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.example.pro.rumahcemara.models.GeneralDataProfile obj = new com.example.pro.rumahcemara.models.GeneralDataProfile();
        final com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.pro.rumahcemara.models.GeneralDataProfile copyOrUpdate(Realm realm, com.example.pro.rumahcemara.models.GeneralDataProfile object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.pro.rumahcemara.models.GeneralDataProfile) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.example.pro.rumahcemara.models.GeneralDataProfile copy(Realm realm, com.example.pro.rumahcemara.models.GeneralDataProfile newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.pro.rumahcemara.models.GeneralDataProfile realmObject = realm.createObjectInternal(com.example.pro.rumahcemara.models.GeneralDataProfile.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) newObject;
        com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface realmObjectCopy = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.pro.rumahcemara.models.GeneralDataProfile object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.GeneralDataProfile.class);
        long tableNativePtr = table.getNativePtr();
        GeneralDataProfileColumnInfo columnInfo = (GeneralDataProfileColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.GeneralDataProfile.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$id = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$roleId = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$roleId();
        if (realmGet$roleId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.roleIdIndex, rowIndex, realmGet$roleId, false);
        }
        String realmGet$username = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$username();
        if (realmGet$username != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.usernameIndex, rowIndex, realmGet$username, false);
        }
        String realmGet$status = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$createdAt = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updateAt = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$updateAt();
        if (realmGet$updateAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updateAtIndex, rowIndex, realmGet$updateAt, false);
        }
        String realmGet$deletedAt = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$deletedAt();
        ...
        com.example.pro.rumahcemara.models.Profile profileObj = ((com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) object).realmGet$profile();
        if (profileObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        GeneralDataProfileColumnInfo columnInfo = (GeneralDataProfileColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.GeneralDataProfile.class);
        com.example.pro.rumahcemara.models.GeneralDataProfile object = null;
        while (objects.hasNext()) {
            object = (com.example.pro.rumahcemara.models.GeneralDataProfile) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.pro.rumahcemara.models.GeneralDataProfile object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.GeneralDataProfile.class);
    ...
    public static com.example.pro.rumahcemara.models.GeneralDataProfile createDetachedCopy(com.example.pro.rumahcemara.models.GeneralDataProfile realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.pro.rumahcemara.models.GeneralDataProfile unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.pro.rumahcemara.models.GeneralDataProfile();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.pro.rumahcemara.models.GeneralDataProfile) cachedObject.object;
            }
            unmanagedObject = (com.example.pro.rumahcemara.models.GeneralDataProfile) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface unmanagedCopy = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) unmanagedObject;
        com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface realmSource = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxy aGeneralDataProfile = (com_example_pro_rumahcemara_models_GeneralDataProfileRealmProxy)o;
