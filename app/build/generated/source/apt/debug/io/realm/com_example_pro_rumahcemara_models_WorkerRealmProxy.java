...
public class com_example_pro_rumahcemara_models_WorkerRealmProxy extends com.example.pro.rumahcemara.models.Worker
    implements RealmObjectProxy, com_example_pro_rumahcemara_models_WorkerRealmProxyInterface {
    ...
    private ProxyState<com.example.pro.rumahcemara.models.Worker> proxyState;

    com_example_pro_rumahcemara_models_WorkerRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.pro.rumahcemara.models.Worker>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.pro.rumahcemara.models.Worker createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.example.pro.rumahcemara.models.Worker obj = null;
        if (update) {
            Table table = realm.getTable(com.example.pro.rumahcemara.models.Worker.class);
            WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Worker.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Worker.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_example_pro_rumahcemara_models_WorkerRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_example_pro_rumahcemara_models_WorkerRealmProxy) realm.createObjectInternal(com.example.pro.rumahcemara.models.Worker.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_example_pro_rumahcemara_models_WorkerRealmProxy) realm.createObjectInternal(com.example.pro.rumahcemara.models.Worker.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_example_pro_rumahcemara_models_WorkerRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) obj;
    ...
    public static com.example.pro.rumahcemara.models.Worker createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.example.pro.rumahcemara.models.Worker obj = new com.example.pro.rumahcemara.models.Worker();
        final com_example_pro_rumahcemara_models_WorkerRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.pro.rumahcemara.models.Worker copyOrUpdate(Realm realm, com.example.pro.rumahcemara.models.Worker object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.pro.rumahcemara.models.Worker) cachedRealmObject;
        }

        com.example.pro.rumahcemara.models.Worker realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.example.pro.rumahcemara.models.Worker.class);
            WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Worker.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Worker.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_example_pro_rumahcemara_models_WorkerRealmProxy();
    ...
    public static com.example.pro.rumahcemara.models.Worker copy(Realm realm, com.example.pro.rumahcemara.models.Worker newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.pro.rumahcemara.models.Worker realmObject = realm.createObjectInternal(com.example.pro.rumahcemara.models.Worker.class, ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_pro_rumahcemara_models_WorkerRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) newObject;
        com_example_pro_rumahcemara_models_WorkerRealmProxyInterface realmObjectCopy = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.pro.rumahcemara.models.Worker object, Map<RealmModel,Long> cache) {
        ...
        WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Worker.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$username = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$username();
        if (realmGet$username != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.usernameIndex, rowIndex, realmGet$username, false);
        }
        String realmGet$email = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$password = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$password();
        if (realmGet$password != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.passwordIndex, rowIndex, realmGet$password, false);
        }
        String realmGet$roleId = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$roleId();
        if (realmGet$roleId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.roleIdIndex, rowIndex, realmGet$roleId, false);
        }
        Number realmGet$status = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetLong(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status.longValue(), false);
        }
        String realmGet$createdAt = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updatedAt = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updatedAtIndex, rowIndex, realmGet$updatedAt, false);
        }
        String realmGet$deletedAt = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$deletedAt();
        ...
        com.example.pro.rumahcemara.models.Profile profileObj = ((com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) object).realmGet$profile();
        if (profileObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        WorkerColumnInfo columnInfo = (WorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Worker.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.example.pro.rumahcemara.models.Worker object = null;
        while (objects.hasNext()) {
            object = (com.example.pro.rumahcemara.models.Worker) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.pro.rumahcemara.models.Worker object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.Worker.class);
    ...
    public static com.example.pro.rumahcemara.models.Worker createDetachedCopy(com.example.pro.rumahcemara.models.Worker realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.pro.rumahcemara.models.Worker unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.pro.rumahcemara.models.Worker();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.pro.rumahcemara.models.Worker) cachedObject.object;
            }
            unmanagedObject = (com.example.pro.rumahcemara.models.Worker) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_pro_rumahcemara_models_WorkerRealmProxyInterface unmanagedCopy = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) unmanagedObject;
        com_example_pro_rumahcemara_models_WorkerRealmProxyInterface realmSource = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) realmObject;
    ...
    static com.example.pro.rumahcemara.models.Worker update(Realm realm, com.example.pro.rumahcemara.models.Worker realmObject, com.example.pro.rumahcemara.models.Worker newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_example_pro_rumahcemara_models_WorkerRealmProxyInterface realmObjectTarget = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) realmObject;
        com_example_pro_rumahcemara_models_WorkerRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_WorkerRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_pro_rumahcemara_models_WorkerRealmProxy aWorker = (com_example_pro_rumahcemara_models_WorkerRealmProxy)o;
