...
public class com_example_pro_rumahcemara_models_RegisterRealmProxy extends com.example.pro.rumahcemara.models.Register
    implements RealmObjectProxy, com_example_pro_rumahcemara_models_RegisterRealmProxyInterface {
    ...
    private ProxyState<com.example.pro.rumahcemara.models.Register> proxyState;

    com_example_pro_rumahcemara_models_RegisterRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.pro.rumahcemara.models.Register>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.pro.rumahcemara.models.Register createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.example.pro.rumahcemara.models.Register obj = realm.createObjectInternal(com.example.pro.rumahcemara.models.Register.class, true, excludeFields);

        final com_example_pro_rumahcemara_models_RegisterRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) obj;
    ...
    public static com.example.pro.rumahcemara.models.Register createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.example.pro.rumahcemara.models.Register obj = new com.example.pro.rumahcemara.models.Register();
        final com_example_pro_rumahcemara_models_RegisterRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.pro.rumahcemara.models.Register copyOrUpdate(Realm realm, com.example.pro.rumahcemara.models.Register object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.pro.rumahcemara.models.Register) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.example.pro.rumahcemara.models.Register copy(Realm realm, com.example.pro.rumahcemara.models.Register newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.pro.rumahcemara.models.Register realmObject = realm.createObjectInternal(com.example.pro.rumahcemara.models.Register.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_pro_rumahcemara_models_RegisterRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) newObject;
        com_example_pro_rumahcemara_models_RegisterRealmProxyInterface realmObjectCopy = (com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.pro.rumahcemara.models.Register object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.Register.class);
        long tableNativePtr = table.getNativePtr();
        RegisterColumnInfo columnInfo = (RegisterColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Register.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$username = ((com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) object).realmGet$username();
        if (realmGet$username != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.usernameIndex, rowIndex, realmGet$username, false);
        }
        String realmGet$password = ((com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) object).realmGet$password();
        if (realmGet$password != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.passwordIndex, rowIndex, realmGet$password, false);
        }
        String realmGet$fullname = ((com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) object).realmGet$fullname();
        if (realmGet$fullname != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fullnameIndex, rowIndex, realmGet$fullname, false);
        }
        String realmGet$phoneNumber = ((com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) object).realmGet$phoneNumber();
        if (realmGet$phoneNumber != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneNumberIndex, rowIndex, realmGet$phoneNumber, false);
        }
        String realmGet$email = ((com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$dso = ((com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) object).realmGet$dso();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        RegisterColumnInfo columnInfo = (RegisterColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.Register.class);
        com.example.pro.rumahcemara.models.Register object = null;
        while (objects.hasNext()) {
            object = (com.example.pro.rumahcemara.models.Register) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.pro.rumahcemara.models.Register object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.Register.class);
    ...
    public static com.example.pro.rumahcemara.models.Register createDetachedCopy(com.example.pro.rumahcemara.models.Register realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.pro.rumahcemara.models.Register unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.pro.rumahcemara.models.Register();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.pro.rumahcemara.models.Register) cachedObject.object;
            }
            unmanagedObject = (com.example.pro.rumahcemara.models.Register) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_pro_rumahcemara_models_RegisterRealmProxyInterface unmanagedCopy = (com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) unmanagedObject;
        com_example_pro_rumahcemara_models_RegisterRealmProxyInterface realmSource = (com_example_pro_rumahcemara_models_RegisterRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_pro_rumahcemara_models_RegisterRealmProxy aRegister = (com_example_pro_rumahcemara_models_RegisterRealmProxy)o;
