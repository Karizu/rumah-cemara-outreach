...
class RumahCemaraRealmModuleMediator extends RealmProxyMediator {
    ...
    static {
        ...
        modelClasses.add(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class);
    ...
    public Map<Class<? extends RealmModel>, OsObjectSchemaInfo> getExpectedObjectSchemaInfoMap() {
        ...
        infoMap.put(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class, io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.getExpectedObjectSchemaInfo());
    ...
    public ColumnInfo createColumnInfo(Class<? extends RealmModel> clazz, OsSchemaInfo schemaInfo) {
        ...
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
            return io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.createColumnInfo(schemaInfo);
        }
    ...
    public <E extends RealmModel> E newInstance(Class<E> clazz, Object baseRealm, Row row, ColumnInfo columnInfo, boolean acceptDefaultValue, List<String> excludeFields) {
        ...
        try {
            ...
            if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
                return clazz.cast(new io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy());
            }
            if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public <E extends RealmModel> E copyOrUpdate(Realm realm, E obj, boolean update, Map<RealmModel, RealmObjectProxy> cache) {
        ...
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
            return clazz.cast(io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.copyOrUpdate(realm, (com.boardinglabs.rumahcemara.outreach.models.Dashboard) obj, update, cache));
        }
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public void insert(Realm realm, RealmModel object, Map<RealmModel, Long> cache) {
        ...
        } else if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
            io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.insert(realm, (com.boardinglabs.rumahcemara.outreach.models.Dashboard) object, cache);
        ...
        if (iterator.hasNext()) {
            ...
            if (iterator.hasNext()) {
                if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Profile.class)) {
                    ...
                    io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.insert(realm, iterator, cache);
                } else if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public void insertOrUpdate(Realm realm, RealmModel obj, Map<RealmModel, Long> cache) {
        ...
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Profile.class)) {
            ...
            io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.insertOrUpdate(realm, (com.boardinglabs.rumahcemara.outreach.models.Dashboard) obj, cache);
        } else if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public void insertOrUpdate(Realm realm, Collection<? extends RealmModel> objects) {
        ...
        if (iterator.hasNext()) {
            ...
            if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Profile.class)) {
                ...
                io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.insertOrUpdate(realm, (com.boardinglabs.rumahcemara.outreach.models.Dashboard) object, cache);
            } else if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
            ...
            if (iterator.hasNext()) {
                if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Profile.class)) {
                    ...
                    io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.insertOrUpdate(realm, iterator, cache);
                } else if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public <E extends RealmModel> E createOrUpdateUsingJsonObject(Class<E> clazz, Realm realm, JSONObject json, boolean update)
        ...
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
            return clazz.cast(io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.createOrUpdateUsingJsonObject(realm, json, update));
        }
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public <E extends RealmModel> E createUsingJsonStream(Class<E> clazz, Realm realm, JsonReader reader)
        ...
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
            return clazz.cast(io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.createUsingJsonStream(realm, reader));
        }
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
    ...
    public <E extends RealmModel> E createDetachedCopy(E realmObject, int maxDepth, Map<RealmModel, RealmObjectProxy.CacheData<RealmModel>> cache) {
        ...
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Dashboard.class)) {
            return clazz.cast(io.realm.com_boardinglabs_rumahcemara_outreach_models_DashboardRealmProxy.createDetachedCopy((com.boardinglabs.rumahcemara.outreach.models.Dashboard) realmObject, 0, maxDepth, cache));
        }
        if (clazz.equals(com.boardinglabs.rumahcemara.outreach.models.Worker.class)) {
