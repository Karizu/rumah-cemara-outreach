...
public class com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy extends com.boardinglabs.rumahcemara.outreach.models.Rating
    implements RealmObjectProxy, com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface {
    ...
    private ProxyState<com.boardinglabs.rumahcemara.outreach.models.Rating> proxyState;

    com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.boardinglabs.rumahcemara.outreach.models.Rating>(this);
    ...
    @SuppressWarnings("cast")
    public static com.boardinglabs.rumahcemara.outreach.models.Rating createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.boardinglabs.rumahcemara.outreach.models.Rating obj = null;
        if (update) {
            Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
            RatingColumnInfo columnInfo = (RatingColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Rating.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy) realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Rating.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy) realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Rating.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) obj;
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Rating createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.boardinglabs.rumahcemara.outreach.models.Rating obj = new com.boardinglabs.rumahcemara.outreach.models.Rating();
        final com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface objProxy = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Rating copyOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Rating object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.boardinglabs.rumahcemara.outreach.models.Rating) cachedRealmObject;
        }

        com.boardinglabs.rumahcemara.outreach.models.Rating realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
            RatingColumnInfo columnInfo = (RatingColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Rating.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy();
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Rating copy(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Rating newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.boardinglabs.rumahcemara.outreach.models.Rating realmObject = realm.createObjectInternal(com.boardinglabs.rumahcemara.outreach.models.Rating.class, ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) newObject;
        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface realmObjectCopy = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Rating object, Map<RealmModel,Long> cache) {
        ...
        RatingColumnInfo columnInfo = (RatingColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$service_transaction_id = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$service_transaction_id();
        ...
        String realmGet$user_id = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$user_id();
        if (realmGet$user_id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.user_idIndex, rowIndex, realmGet$user_id, false);
        }
        String realmGet$provider_id = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$provider_id();
        ...
        String realmGet$type = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$type();
        if (realmGet$type != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.typeIndex, rowIndex, realmGet$type, false);
        }
        String realmGet$rating = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$rating();
        if (realmGet$rating != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.ratingIndex, rowIndex, realmGet$rating, false);
        }
        String realmGet$description = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$description();
        if (realmGet$description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.descriptionIndex, rowIndex, realmGet$description, false);
        }
        String realmGet$created_at = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$created_at();
        if (realmGet$created_at != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.created_atIndex, rowIndex, realmGet$created_at, false);
        }
        String realmGet$updated_at = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$updated_at();
        if (realmGet$updated_at != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updated_atIndex, rowIndex, realmGet$updated_at, false);
        }
        String realmGet$deleted_at = ((com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) object).realmGet$deleted_at();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        RatingColumnInfo columnInfo = (RatingColumnInfo) realm.getSchema().getColumnInfo(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.boardinglabs.rumahcemara.outreach.models.Rating object = null;
        while (objects.hasNext()) {
            object = (com.boardinglabs.rumahcemara.outreach.models.Rating) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Rating object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.boardinglabs.rumahcemara.outreach.models.Rating.class);
    ...
    public static com.boardinglabs.rumahcemara.outreach.models.Rating createDetachedCopy(com.boardinglabs.rumahcemara.outreach.models.Rating realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.boardinglabs.rumahcemara.outreach.models.Rating unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.boardinglabs.rumahcemara.outreach.models.Rating();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.boardinglabs.rumahcemara.outreach.models.Rating) cachedObject.object;
            }
            unmanagedObject = (com.boardinglabs.rumahcemara.outreach.models.Rating) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface unmanagedCopy = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) unmanagedObject;
        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface realmSource = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) realmObject;
    ...
    static com.boardinglabs.rumahcemara.outreach.models.Rating update(Realm realm, com.boardinglabs.rumahcemara.outreach.models.Rating realmObject, com.boardinglabs.rumahcemara.outreach.models.Rating newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface realmObjectTarget = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) realmObject;
        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface realmObjectSource = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy aRating = (com_boardinglabs_rumahcemara_outreach_models_RatingRealmProxy)o;
