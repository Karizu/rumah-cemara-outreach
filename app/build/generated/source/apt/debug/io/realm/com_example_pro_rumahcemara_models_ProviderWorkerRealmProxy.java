...
public class com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy extends com.example.pro.rumahcemara.models.ProviderWorker
    implements RealmObjectProxy, com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface {
    ...
    private ProxyState<com.example.pro.rumahcemara.models.ProviderWorker> proxyState;

    com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.pro.rumahcemara.models.ProviderWorker>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.pro.rumahcemara.models.ProviderWorker createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.example.pro.rumahcemara.models.ProviderWorker obj = null;
        if (update) {
            Table table = realm.getTable(com.example.pro.rumahcemara.models.ProviderWorker.class);
            ProviderWorkerColumnInfo columnInfo = (ProviderWorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ProviderWorker.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ProviderWorker.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy) realm.createObjectInternal(com.example.pro.rumahcemara.models.ProviderWorker.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy) realm.createObjectInternal(com.example.pro.rumahcemara.models.ProviderWorker.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) obj;
    ...
    public static com.example.pro.rumahcemara.models.ProviderWorker createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.example.pro.rumahcemara.models.ProviderWorker obj = new com.example.pro.rumahcemara.models.ProviderWorker();
        final com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.pro.rumahcemara.models.ProviderWorker copyOrUpdate(Realm realm, com.example.pro.rumahcemara.models.ProviderWorker object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.pro.rumahcemara.models.ProviderWorker) cachedRealmObject;
        }

        com.example.pro.rumahcemara.models.ProviderWorker realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.example.pro.rumahcemara.models.ProviderWorker.class);
            ProviderWorkerColumnInfo columnInfo = (ProviderWorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ProviderWorker.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ProviderWorker.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy();
    ...
    public static com.example.pro.rumahcemara.models.ProviderWorker copy(Realm realm, com.example.pro.rumahcemara.models.ProviderWorker newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.pro.rumahcemara.models.ProviderWorker realmObject = realm.createObjectInternal(com.example.pro.rumahcemara.models.ProviderWorker.class, ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) newObject;
        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface realmObjectCopy = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.pro.rumahcemara.models.ProviderWorker object, Map<RealmModel,Long> cache) {
        ...
        ProviderWorkerColumnInfo columnInfo = (ProviderWorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ProviderWorker.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$username = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$username();
        if (realmGet$username != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.usernameIndex, rowIndex, realmGet$username, false);
        }
        String realmGet$email = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$password = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$password();
        if (realmGet$password != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.passwordIndex, rowIndex, realmGet$password, false);
        }
        String realmGet$roleId = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$roleId();
        if (realmGet$roleId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.roleIdIndex, rowIndex, realmGet$roleId, false);
        }
        Number realmGet$status = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetLong(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status.longValue(), false);
        }
        String realmGet$createdAt = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updatedAt = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updatedAtIndex, rowIndex, realmGet$updatedAt, false);
        }
        String realmGet$deletedAt = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$deletedAt();
        ...
        com.example.pro.rumahcemara.models.Profile profileObj = ((com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) object).realmGet$profile();
        if (profileObj != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ProviderWorkerColumnInfo columnInfo = (ProviderWorkerColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ProviderWorker.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.example.pro.rumahcemara.models.ProviderWorker object = null;
        while (objects.hasNext()) {
            object = (com.example.pro.rumahcemara.models.ProviderWorker) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.pro.rumahcemara.models.ProviderWorker object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.ProviderWorker.class);
    ...
    public static com.example.pro.rumahcemara.models.ProviderWorker createDetachedCopy(com.example.pro.rumahcemara.models.ProviderWorker realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.pro.rumahcemara.models.ProviderWorker unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.pro.rumahcemara.models.ProviderWorker();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.pro.rumahcemara.models.ProviderWorker) cachedObject.object;
            }
            unmanagedObject = (com.example.pro.rumahcemara.models.ProviderWorker) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface unmanagedCopy = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) unmanagedObject;
        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface realmSource = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) realmObject;
    ...
    static com.example.pro.rumahcemara.models.ProviderWorker update(Realm realm, com.example.pro.rumahcemara.models.ProviderWorker realmObject, com.example.pro.rumahcemara.models.ProviderWorker newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface realmObjectTarget = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) realmObject;
        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy aProviderWorker = (com_example_pro_rumahcemara_models_ProviderWorkerRealmProxy)o;
