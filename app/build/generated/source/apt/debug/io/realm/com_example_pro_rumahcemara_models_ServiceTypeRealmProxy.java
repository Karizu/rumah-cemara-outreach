...
public class com_example_pro_rumahcemara_models_ServiceTypeRealmProxy extends com.example.pro.rumahcemara.models.ServiceType
    implements RealmObjectProxy, com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface {
    ...
    private ProxyState<com.example.pro.rumahcemara.models.ServiceType> proxyState;

    com_example_pro_rumahcemara_models_ServiceTypeRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.pro.rumahcemara.models.ServiceType>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.pro.rumahcemara.models.ServiceType createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.example.pro.rumahcemara.models.ServiceType obj = null;
        if (update) {
            Table table = realm.getTable(com.example.pro.rumahcemara.models.ServiceType.class);
            ServiceTypeColumnInfo columnInfo = (ServiceTypeColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ServiceType.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ServiceType.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_example_pro_rumahcemara_models_ServiceTypeRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_example_pro_rumahcemara_models_ServiceTypeRealmProxy) realm.createObjectInternal(com.example.pro.rumahcemara.models.ServiceType.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_example_pro_rumahcemara_models_ServiceTypeRealmProxy) realm.createObjectInternal(com.example.pro.rumahcemara.models.ServiceType.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) obj;
    ...
    public static com.example.pro.rumahcemara.models.ServiceType createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.example.pro.rumahcemara.models.ServiceType obj = new com.example.pro.rumahcemara.models.ServiceType();
        final com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface objProxy = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.pro.rumahcemara.models.ServiceType copyOrUpdate(Realm realm, com.example.pro.rumahcemara.models.ServiceType object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.pro.rumahcemara.models.ServiceType) cachedRealmObject;
        }

        com.example.pro.rumahcemara.models.ServiceType realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.example.pro.rumahcemara.models.ServiceType.class);
            ServiceTypeColumnInfo columnInfo = (ServiceTypeColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ServiceType.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ServiceType.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_example_pro_rumahcemara_models_ServiceTypeRealmProxy();
    ...
    public static com.example.pro.rumahcemara.models.ServiceType copy(Realm realm, com.example.pro.rumahcemara.models.ServiceType newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.pro.rumahcemara.models.ServiceType realmObject = realm.createObjectInternal(com.example.pro.rumahcemara.models.ServiceType.class, ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) newObject;
        com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface realmObjectCopy = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.pro.rumahcemara.models.ServiceType object, Map<RealmModel,Long> cache) {
        ...
        ServiceTypeColumnInfo columnInfo = (ServiceTypeColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ServiceType.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$parentId = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$parentId();
        if (realmGet$parentId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.parentIdIndex, rowIndex, realmGet$parentId, false);
        }
        String realmGet$pic = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$pic();
        if (realmGet$pic != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.picIndex, rowIndex, realmGet$pic, false);
        }
        String realmGet$name = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$address = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$address();
        if (realmGet$address != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.addressIndex, rowIndex, realmGet$address, false);
        }
        String realmGet$type = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$type();
        if (realmGet$type != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.typeIndex, rowIndex, realmGet$type, false);
        }
        String realmGet$areas = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$areas();
        if (realmGet$areas != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.areasIndex, rowIndex, realmGet$areas, false);
        }
        Boolean realmGet$isParent = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$isParent();
        if (realmGet$isParent != null) {
            Table.nativeSetBoolean(tableNativePtr, columnInfo.isParentIndex, rowIndex, realmGet$isParent, false);
        }
        String realmGet$createdAt = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$createdAt();
        if (realmGet$createdAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.createdAtIndex, rowIndex, realmGet$createdAt, false);
        }
        String realmGet$updatedAt = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$updatedAt();
        if (realmGet$updatedAt != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.updatedAtIndex, rowIndex, realmGet$updatedAt, false);
        }
        String realmGet$deletedAt = ((com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) object).realmGet$deletedAt();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        ServiceTypeColumnInfo columnInfo = (ServiceTypeColumnInfo) realm.getSchema().getColumnInfo(com.example.pro.rumahcemara.models.ServiceType.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.example.pro.rumahcemara.models.ServiceType object = null;
        while (objects.hasNext()) {
            object = (com.example.pro.rumahcemara.models.ServiceType) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.pro.rumahcemara.models.ServiceType object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.pro.rumahcemara.models.ServiceType.class);
    ...
    public static com.example.pro.rumahcemara.models.ServiceType createDetachedCopy(com.example.pro.rumahcemara.models.ServiceType realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.pro.rumahcemara.models.ServiceType unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.pro.rumahcemara.models.ServiceType();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.pro.rumahcemara.models.ServiceType) cachedObject.object;
            }
            unmanagedObject = (com.example.pro.rumahcemara.models.ServiceType) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface unmanagedCopy = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) unmanagedObject;
        com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface realmSource = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) realmObject;
    ...
    static com.example.pro.rumahcemara.models.ServiceType update(Realm realm, com.example.pro.rumahcemara.models.ServiceType realmObject, com.example.pro.rumahcemara.models.ServiceType newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface realmObjectTarget = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) realmObject;
        com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface realmObjectSource = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_pro_rumahcemara_models_ServiceTypeRealmProxy aServiceType = (com_example_pro_rumahcemara_models_ServiceTypeRealmProxy)o;
