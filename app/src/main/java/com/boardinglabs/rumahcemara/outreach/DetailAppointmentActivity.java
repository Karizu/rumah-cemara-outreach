...
public class DetailAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_biomedical_appointment);
...
//        });
    ...
    @OnClick(R.id.btnEndAppointment)
    void onClickEndAppointment(){
        ...
        API.baseApiService().updateStatus(serviceId, status, sBearerToken).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                Toast.makeText(DetailAppointmentActivity.this, "Appointment Ended", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(DetailAppointmentActivity.this, MainActivity.class);
